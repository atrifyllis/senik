...
-- Initia feature flags about Insurance Types (only TSMEDE enabled)
INSERT INTO ff4j_features (feat_uid, enable, description, strategy, expression, groupname)
VALUES ('TSMEDE', 1, 'TSMEDE calculations (engineers)', null, null, null);

INSERT INTO ff4j_features (feat_uid, enable, description, strategy, expression, groupname)
VALUES ('OAEE', 0, 'OAEE calculations (merchants etc.)', null, null, null);

INSERT INTO ff4j_features (feat_uid, enable, description, strategy, expression, groupname)
VALUES ('TSAY', 0, 'TSAY calculations (doctors etc.)', null, null, null);

INSERT INTO ff4j_features (feat_uid, enable, description, strategy, expression, groupname)
VALUES ('OGA', 0, 'OGA calculations (farmers etc.)', null, null, null);
